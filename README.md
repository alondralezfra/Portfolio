...
Custom physics simulation (Navier–Stokes inspired)

Purpose

This project serves as both:

A personal portfolio showcasing my experience and projects

A technical playground for experimenting with real-time simulations, clean architecture, and interactive UI design
